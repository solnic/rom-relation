...
require 'data_mapper/relation/graph/node/aliases/index'
require 'data_mapper/relation/graph/node/aliases/strategy'
require 'data_mapper/relation/graph/node/aliases/strategy/natural_join'
require 'data_mapper/relation/graph/node/aliases/strategy/inner_join'
